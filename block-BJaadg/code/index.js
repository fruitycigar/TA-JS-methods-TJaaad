...
*/
console.log(`The index of the first occurrence of "is" in the variable "quote" is ${indexOfIs}.` );
/*
...
*/
console.log(`Does quote include the world "Only"? :`, quote.includes(`only`));
/*
8. Does quote includes the word " we"
*/
console.log(`Does quote include the world "we"? :`, quote.includes(`we`));
/*
...
*/
let longQuot = quote.padEnd(70, `.`);
console.log(longQuot);
/*
16. Do same as (15) but the ... should come in start. Store the output in a new variable
*/
let longQuotStart = quote.padStart(70, `.`);
console.log(longQuotStart);
/*
